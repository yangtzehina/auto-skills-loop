...
class VerifyReport(BaseModel):
    ...
    workflow_form_status: str = 'pass'
    workflow_form_fail_count: int = 0
    workflow_form_warn_count: int = 0
    workflow_form_gap_count: int = 0
    editorial_force_status: str = 'pass'
    editorial_force_fail_count: int = 0
    editorial_force_warn_count: int = 0
    editorial_force_gap_count: int = 0
    editorial_force_non_regression: str = 'pass'
    pairwise_promotion_status: str = 'pass'
