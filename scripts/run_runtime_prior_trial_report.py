...
from openclaw_skill_create.services.ops_post_apply import build_prior_pilot_trial_observation_report
...
def _usage() -> str:
    return (
        'Usage: python scripts/run_runtime_prior_trial_report.py '
